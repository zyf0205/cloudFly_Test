...
/* LED序列优先级 */
static ledseq_t const * sequences[] = /*指针数组*/
{
	seq_lowbat,/*ledseq_t数组类型的首地址*/
	seq_charged,
	seq_charging,
	seq_calibrated,
	seq_alive,
...
/*Led 序列*/
const ledseq_t seq_lowbat[] = 	/*电池低电压序列*/
{
...
const ledseq_t seq_charging[] = /*电池充电进行中序列*/
{
...
#define SEQ_NUM (sizeof(sequences)/sizeof(sequences[0]))/*获取数组元素个数*/
