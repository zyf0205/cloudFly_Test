...
static void atkpReceiveAnl(atkp_t *anlPacket)
{
	...
	// 	{
	// 		resetConfigParamPID(); /*重置pid参数为默认值*/
	...
	{
		/*直接将接收到的遥控数据复制到本地变量*/
		rcdata = *((joystickFlyui16_t*)anlPacket->data);/*从data[0]开始的八个字节为结构体*/
	}
	/*电源管理数据*/
...
// 		setMotorPWM(enable,m1_set,m2_set,m3_set,m4_set);/*直接设置电机pwm*/
