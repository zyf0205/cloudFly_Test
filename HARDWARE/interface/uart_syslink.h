...
#define UARTSLK_IRQ              USART2_IRQn/*串口中断*/

#define UARTSLK_DMA_IRQ          DMA1_Stream6_IRQn	/*dma中断号*/
#define UARTSLK_DMA_IT_TC        DMA_IT_TC /*传输完成中断标志(通用)*/
#define UARTSLK_DMA_STREAM       DMA1_Stream6 
#define UARTSLK_DMA_CH           DMA_Channel_4 /*dma传输通道*/
#define UARTSLK_DMA_IT_TCIF    	 DMA_IT_TCIF6 /*传输完成中断标志(stream6专用)*/
